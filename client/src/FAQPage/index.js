...
class FaqPage extends Component {
  ...
  render(){
    return (
      <div className="FaqPage gray_border_top proxima">
    <section className="padding_top25 padding_bottom80 sides13pct">
      <div>
        <h2 className="font22 light title padding_top20">What is The Rotation?</h2>
        <div className="top10 font18 light rotation_gray">
          Welcome to The Rotation. We provide our members with exclusive access to a closet full of designer clothes and
          streetwear for a fraction of the price. Our plans give you the ability to wear 2, 3, or 4 styles at a time, for
          as
          long as you went. When you're tired of a piece just send it back and select the next thing on your rotation.
          More
          access, more flexibility, and more experimentation for a fraction of the cost of retail or resale.

        </div>
        <h2 className="font22 light title padding_top20">How does it work?</h2>
        <div className="top10 font18 light rotation_gray">
        ...
        <div className="top10 font18 light rotation_gray">
          At the moment, we ship all over the United States of America. We look forward to serving our international
          friends
          soon.

        </div>
        <h2 className="font22 light title padding_top20">What if I want to buy my item?</h2>
        <div className="top10 font18 light rotation_gray">
          Tap on your item in The Rotation app and tap "Request to Buy". Our merchandising team will send you an email
          quote
          with a purchase link shortly after.

        </div>
        <h2 className="font22 light title padding_top20">Do you offer discounts for purchasing my item?</h2>
        <div className="top10 font18 light rotation_gray">
          If applicable, we offer a variable discount based on the amount of time you've had an item out. The longer you
          hold on to it, the bigger the discount, so you can make sure you love an item before you commit to it for life.

        </div>
        <h2 className="font22 light title padding_top20">How often are new items released?</h2>
        <div className="top10 font18 light rotation_gray">
          We release new clothing every two weeks during The Drop. Wednesday evenings, check your email for information on
          our latest styles and designers that were just announced.

        </div>
        <h2 className="font22 light title padding_top20">Do you have a newsletter?</h2>
        <div className="top10 font18 light rotation_gray">
          Yes, we do. Sign up here for our newsletter, where we fill you in on The Drop and new service features and
          announcements.
        ...
        <h2 className="font22 light title padding_top20">When will I receive my first order?</h2>
        <div className="top10 font18 light rotation_gray">
        ...
        <div className="top10 font18 light rotation_gray">
          Once you sign up for a plan, your card will be charged, so choose your first items quickly!

        </div>
        <h2 className="font22 light title padding_top20">What is a heart? Why should I heart items?</h2>
        <div className="top10 font18 light rotation_gray">
          A 'heart' is a way to save items in your catalog. Tapping on the heart will move items to your favorites, so you
          can access them easier for your next rotation. It lets our team know which styles you love, and what you may
          want
          more of, so heart away!

        </div>
        <h2 className="font22 light title padding_top20">What should I do with the package or box?</h2>
        <div className="top10 font18 light rotation_gray">
          Save the box your items came in! You'll re-use it along with the included pre-paid shipping label to send back
          your items.

        </div>
        <h2 className="font22 light title padding_top20">How do I get a new item?</h2>
        <div className="top10 font18 light rotation_gray">
          Once we receive your items, they'll be processed immediately and your new item slots will open up. We'll be sure
          to alert you when that happens.

        </div>
        <h2 className="font22 light title padding_top20">Do I have to return all my items at once?</h2>
        <div className="top10 font18 light rotation_gray">
          You do not have to return all your items together. If you want to hold on to one just a little bit longer,
          you're
          good to send back the others and those respective item slots will open up once we process those returns.

        </div>
        <h2 className="font22 light title padding_top20">What type of items do you carry?</h2>
        <div className="top10 font18 light rotation_gray">
          We carry items across the fashion spectrum, primarily in these categories:

          - Tees / tops
          - Outwear / hoodies / jackets / parkas
          - Accessories such as rings, bracelets, and necklaces
          - Bags
        </div>
        <h2 className="font22 light title padding_top20">How do I keep track of my favorite pieces?</h2>
        <div className="top10 font18 light rotation_gray">
          Tap the 'heart' icon to add any piece to your favorites section. We'll use this information to inform future
          drops
          and make sure our stylists keep your style in mind.

        </div>
        <h2 className="font22 light title padding_top20">How do I get items from the drop?</h2>
        <div className="top10 font18 light rotation_gray">
        ...
        <div className="top10 font18 light rotation_gray">
          The Rotation catalog is built to look good on anyone. We've ensured our drops are curated to an expert level of
        ...
        <div className="top10 font18 light rotation_gray">
          These pieces are more than meets the eye. We suggest you give a style a shot. You'll be surprised about how good
          you
          feel and how confident you'll be in them.
        ...
        <h2 className="font22 light title padding_top20">Why are some items "Sold Out"?</h2>
        <div className="top10 font18 light rotation_gray">
          That means other members are currently enjoying all of the available inventory of that particular item. Add a
          sold
          out item to your favorites to stay up to date on its availability.

        </div>
        <h2 className="font22 light title padding_top20">How can I see items in my size?</h2>
        <div className="top10 font18 light rotation_gray">
          Tap the size filters at the top of the catalog to filter all of our inventory by size. However, some styles in
          certain sizes may fit differently than others

        </div>
        <h2 className="font22 light title padding_top20">What subscriptions do you offer?</h2>
        <div className="top10 font18 light rotation_gray">
          Currently, we offer three tiers of subscriptions, with the only difference being the number of item slots at
          your
          disposal. Choose between 2, 3, or 4 items at a time, and swap whenever you want. None of our plans have any time
          limits.
        ...
        <div className="top10 font18 light rotation_gray">
          As long as you want. We don't have limits on our members rotations, as long as their account is active. If you
          cancel your membership, you'll have to return your items within 24 hours or purchase them.
      ...
      <h2 className="font22 light title padding_top20">How do I contact The Rotation?</h2>
      <div className="top10 font18 light rotation_gray">
        Questions, comments, concerns? Reach out for anything - hello@therotation.club.

      </div>
      <h2 className="font22 light title padding_top20">How does swapping an item work?</h2>
      <div className="top10 font18 light rotation_gray">
        Whenever you're ready to get a new item, simply send back the items you no longer want, and we'll send you your
        next selections. You can have as many items as your plan accounts for.

      </div>
      <h2 className="font22 light title padding_top20">How do I know if my order has been successfully received?</h2>
      <div className="top10 font18 light rotation_gray">
        We'll send you an email once we've successfully received your return package and let you know we've opened up new
        slot(s) for you.

      </div>
      <h2 className="font22 light title padding_top20">Are you like Rent The Runway for men?</h2>
      <div className="top10 font18 light rotation_gray">
