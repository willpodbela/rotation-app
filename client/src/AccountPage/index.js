...
class AccountPage extends Component {
  ...
  makePayment(stripeID){
    ...
    console.log("here", stripeID, itemQuantity)
  ...
  render(){
    //FIX CSS OF INPUTS ON MEDIA QUEIRE
    return (
          ...
          <div className="account_inputs top40 sides100">
            ...
            <div className="input_group flex">
              ...
              <div className="input_box gray_border width100 height50 top20 left20">
                ...
                <input className="proxima_xl medium rotation_gray width60 left20" name="zipcode" value={this.state.zipcode} onChange={(e) => this.handleInputChange(e)} />
              </div>
              <div className="input_box gray_border width100 height50 top20 left20">
                <div className="proxima_small medium very_light_gray left20 top5 height15">State</div>
                <input className="proxima_xl medium rotation_gray width60 left20" name="state" value={this.state.state} onChange={(e) => this.handleInputChange(e)} />
              </div>
            </div>
            ...
            <div className="cancel_subscription top20 proxima_small rotation_gray semibold spacing20 uppercase underline cursor_pointer">Cancel Subscription</div>
          </div>
        }
          ...
          <div className="account_inputs top40 sides100">
            <form onSubmit={(e) => this.attemptPayment(e)}>
              ...
              <div className="input_group flex">
                ...
                <div className="input_box gray_border width100 height50 top20 left20">
                  <div className="proxima_small medium very_light_gray left20 top5 height15">Zip</div>
                  <input className="proxima_xl medium rotation_gray width60 left20" name="billingZipcode" value={this.state.billingZipcode} onChange={(e) => this.handleInputChange(e)} />
                </div>
                <div className="input_box gray_border width100 height50 top20 left20">
                  <div className="proxima_small medium very_light_gray left20 top5 height15">State</div>
                  <input className="proxima_xl medium rotation_gray width60 left20" name="billingState" value={this.state.billingState} onChange={(e) => this.handleInputChange(e)} />
                </div>
              </div>
