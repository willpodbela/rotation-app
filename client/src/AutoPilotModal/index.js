      ...
      <Modal show={this.props.show || true} dialogClassName="modal_item" centered>
        <div className="modal_section height500 width_full white_background">
          ...
          <div className="top50 flex justify_center" style={{clear: "right"}}>
              <div>
                <div className="druk_xs medium rotation_gray">Auto Pilot { this.props.userCanEnable && "Settings" }</div>
                ...
                <RTUICheckboxes width="430">
                  ...
                  <span>We'll automatically select the right size based on your reservation history</span>
                </RTUICheckboxes>
