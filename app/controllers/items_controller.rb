class ItemsController < AdminBaseController
  ...
  def set_options
    ...
    @sub_category_options = ["Puffers", "Bombers", "Coats", "Denim Jackets", "Down", "Fur & Shearling", "Jackets", "Leather Jackets", "Peacoats", "Trench Coats", "Vests", "Cargo Pants", "Leather Pants", "Track Pants", "Sweatpants", "Trousers", "Cardigans", "Sweaters", "Knits", "Crewnecks", "Hoodies", "Zipups", "Sweatshirts", "Turtlenecks", "V-Necks", "Henleys", "Polos", "T-Shirts", "Button-ups", "Longsleeves", "Tank Tops", "Rings", "Necklaces", "Bracelets"]
  end
end