class ProfilesController < ApplicationController
  ...
  def profile_params
    ...
    params.require(:profile).permit(:first_name, :last_name, :address_line_one, :address_line_two, :address_city, :address_state, :address_zip, :auto_pilot, :preferred_sizes => [])
  end
